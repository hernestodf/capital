<?php
/**
 * Dashboard Produtor - Baseado no demo.php
 *
 * @var array $stats
 * @var array $producoes
 * @var array $produtos
...
<div class="section-header">
  ...
  <div>
    <div class="section-title">Dashboard Produtor</div>
    <div class="section-sub">Bem-vindo, <?= htmlspecialchars(Rbac::getUser()['name'] ?? 'Produtor') ?>! Gestão de produção.</div>
  </div>
</div>
...
<div class="card" style="margin-top:16px">
  ...
  <div class="card-body">
    <div class="btn-row">
      <?php echo renderButton(['label' => 'Nova Produção', 'variant' => 'cyan', 'size' => 'sm', 'onclick' => "window.location.href='/producao/create'"]); ?>
      <?php echo renderButton(['label' => 'Ver Produtos', 'variant' => 'purple', 'size' => 'sm', 'onclick' => "window.location.href='/produtos'"]); ?>
      <?php echo renderButton(['label' => 'Consultar Estoque', 'variant' => 'green', 'size' => 'sm', 'onclick' => "window.location.href='/estoque'"]); ?>
